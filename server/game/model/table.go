...
func (t *Table) GetActiveSeat() Seat {
	return t.activeSeat
}

func (t *Table) GetReactingPlayers() map[Seat]*Player {
...
func (t *Table) GetPlayerAtSeat(seat Seat) *Player {
...
func (t *Table) DealConcealed(n int, s Seat) {
...
func (t *Table) ActivateSeat(seat Seat) {
	t.activeSeat = seat
}
